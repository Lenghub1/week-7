...
export const updateProductValidator = [
  ...
  check("removedMedia").customSanitizer((value, { req }) => {
    if (!value) return (req.body.removedMedia = []);
    const removedMedia = value.split(",");
    return (req.body.removedMedia = removedMedia);
  }),
];
